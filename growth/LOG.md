...
- Brand source of truth: Google Doc "Sacred Tree Service — Brand Source of Truth (fill-in)" created in the consultant's Drive 2026-08-23 for the in-person session with the owner; when filled, its answers update `company.ts`, schema, llms.txt and the NAP pack (that becomes the W2 work).
