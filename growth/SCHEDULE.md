...
|---|---|---|---|---|---|---|
| 1 | 2026-08-24 | FIX-SCHEMA + FIX-HOST (+ EXIF strip, hero LCP, contact CLS) | Valid LocalBusiness type, robots meta, Article image, Sunday hours, z import, build warnings, image breakpoints; www→apex 308; /workflow/ staff pricing page DELETED; GPS EXIF stripped from all JPEGs + QA check; no reveal-hide above the fold; contact form wrapper height reserved + eager | Y | — | ☑ merged + live 2026-08-23 |
| 2 | 2026-08-31 | LOCAL-NAP-FIX + FIX-SITEMAP (IndexNow) | NAP pack + access checklist already drafted 2026-08-23 (`growth/inbox/out/nap-fix-2026-08-23.md`, `access-setup-2026-08-23.md`) — this week: chase execution, verify listings, drop sitemap tiers, real lastmod, IndexNow key + script, baseline METRICS row once access lands | Y (owner executes listings) | S-MEASURE baseline | ☐ |
